...
public class OrderForCollect_warehouse_Adapter
            extends RecyclerView.Adapter<OrderForCollect_warehouse_Adapter.ViewHolder>{

    public interface RecyclerViewClickListener{
        void onClick(View view, int position);
    }
    private final OrderForCollect_warehouse_Adapter.RecyclerViewClickListener clickListener;
    private final LayoutInflater inflater;
    private final List<CarrierPanelModel> warehouses;

    public OrderForCollect_warehouse_Adapter(Context context,
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new OrderForCollect_warehouse_Adapter.ViewHolder(view,clickListener);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
        ...
        private final OrderForCollect_warehouse_Adapter.RecyclerViewClickListener mListener;

        public ViewHolder(@NonNull View itemView,
                          OrderForCollect_warehouse_Adapter.RecyclerViewClickListener listener) {
            super(itemView);

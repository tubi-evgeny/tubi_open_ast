...
public class ListBuyersIssueGoodsWarehouseAdapter
        extends RecyclerView.Adapter<ListBuyersIssueGoodsWarehouseAdapter.ViewHolder>{

    public interface RecyclerViewClickListener{
        void onClick(View view, int position);
    }
    private final ListBuyersIssueGoodsWarehouseAdapter.RecyclerViewClickListener clickListener;
    private final LayoutInflater inflater;
    private final List<CarrierPanelModel> warehouses;

    public ListBuyersIssueGoodsWarehouseAdapter(Context context,
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ListBuyersIssueGoodsWarehouseAdapter.ViewHolder(view,clickListener);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
        ...
        private final ListBuyersIssueGoodsWarehouseAdapter.RecyclerViewClickListener mListener;


        public ViewHolder(@NonNull View itemView,
                          ListBuyersIssueGoodsWarehouseAdapter.RecyclerViewClickListener listener) {
            super(itemView);

...
public class IntercityDeliveryCalendarActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(outCity.equals("Москва"))outCity_id = 1;
        if(inCity.equals("Смоленск"))inCity_id = 2;
            ...
            for (int y = 1; y <= 7; ++y){
                ...
                text.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        //запретить удалять доставку из календаря если до доставки осталось менее 6 дней
    ...
    //получить даты доставки в города
